...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanAddBasketItem()
        {
            ...
            var controller = new BasketController(basketService, orderService, customers); // this is where we inject the instances of IRepositories
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() {Id = "1", Email = "brett.hargreaves@gmail.com", ZipCode = "90210"});// added fake user to the context
